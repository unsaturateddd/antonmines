document.addEventListener('DOMContentLoaded', function () {
    const cellsBoard = document.querySelector('.container-grid');
    if (!cellsBoard) {
    ...
    if (playButton) {
      playButton.addEventListener('click', function () {
        ...
        let cells = document.querySelectorAll('.container-grid .cel');

        if (!isFirstPlay) {
          cellsBoard.innerHTML = originalState;
          attachCellClickListeners();
          cells = document.querySelectorAll('.container-grid .cel');
        }
